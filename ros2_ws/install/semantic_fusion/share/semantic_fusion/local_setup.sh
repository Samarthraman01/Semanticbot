...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/semantic_fusion"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/semantic_fusion/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/semantic_fusion/environment/path.sh"
